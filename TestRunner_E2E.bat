...
CD %REPO_NAME%
SLEEP 2
CALL mvn clean install site test -Dtest=AllTests -Dbuild.version="1.1"
ECHO.
ECHO Executing Java programm ...
java -jar C:\%WS_DIR%\%REPO_NAME%\target\%REPO_NAME%-%APP_VERSION%.jar %ARG_01%
GOTO END
:EXIT_JAVA
